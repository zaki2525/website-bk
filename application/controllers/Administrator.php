        ...
        if (isset($_POST['lupa'])){
            ...
            if ($cekemail <= 0){
                ...
                $response = false;
                    ...
                    $mail->SMTPAuth = true;
                    $mail->Username = 'bk.smkn1cibinong@gmail.com'; // user email
                    $mail->Password = 'bk5STRONG'; // password email
                    $mail->SMTPSecure = 'ssl';
                    $mail->Port     = 465;
            
                    $mail->setFrom($iden['email'], $iden['nama_website']); // user email
                    $mail->addReplyTo('xxx@hostdomain.com', ''); //user email
            
                    // Add a recipient
                    $mail->addAddress($usr['email']); //email tujuan pengiriman email
	...
	function detail_pesanmasuk(){
		...
		if (isset($_POST['submit'])){
            ...
            $response = false;
                    ...
                    $mail->setFrom('bk.smkn1cibinong@gmail.com', 'bk.smkn1cibinong.sch.com'); // user email
